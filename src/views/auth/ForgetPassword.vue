<template>
    <form action="" ref="forgetPassword" @submit.prevent="forgetPasswordFunc">
        ...
        <p class="form-info mb-4">{{ $t('restorePasswordForm.desc') }}</p>

        <div class="input-g">
            <label for="" class="main-label">{{ $t('restorePasswordForm.phone.text') }}</label>
            <div class="main-input">
                ...
                <Dropdown v-model="selectedCountry" @change="log" :options="countries" optionLabel="name"
                    ...
                    <template #option="slotProps">
                        <div class="option">
                            <img v-if="slotProps.option.image" :alt="slotProps.option.key" class="option-img"
